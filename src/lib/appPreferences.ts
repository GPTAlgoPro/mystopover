...
const translations: Record<LanguageCode, Record<TranslationKey, string>> = {
  'zh-CN': {
    ...
    'home.welcome': '我是龙腾中转礼遇助手。你可以直接说航班、中转时长、行李和想做什么，我会按 PRD 的 6-48 小时中转规则，用对话和卡片带你完成推荐、下单、行李托管、履约追踪；也可以一键套用模板流程快速演示代表性场景。',
  ...
  'en-US': {
    ...
    'flow.journey.step': 'Step 5/5',
    'home.welcome': 'I am DragonPass Stopover Concierge. Tell me your flights, layover length, baggage and what you want to do, and I will follow the PRD 6-48h stopover rules to guide recommendation, order, baggage custody and tracking through conversation plus cards. You can also start from a deterministic template flow.',
