...
const translations: Record<LanguageCode, Record<TranslationKey, string>> = {
  'zh-CN': {
    ...
    'home.welcome': '我是龙腾中转礼遇助手。你可以直接说航班、中转时长、行李和想做什么，我会用对话和卡片带你完成推荐、下单、行李托管、履约追踪；也可以一键套用模板流程快速演示代表性场景。',
    ...
    'packages.subtitle': '为您在中转港的停留智能匹配最优方案',
    ...
    'journey.baggageBody': '行李目前由中转仓储系统实时跟踪保护。离港航班起飞前 90 分钟，系统将指派服务人员自动将行李送抵指定登机口。',
    'journey.pieces': '托运件数',
  ...
  'en-US': {
    ...
    'flow.journey.step': 'Step 5/5',
    'home.welcome': 'I am DragonPass Stopover Concierge. Tell me your flights, layover length, baggage and what you want to do, and I will guide recommendation, order, baggage custody and tracking through conversation plus cards. You can also start from a deterministic template flow.',
